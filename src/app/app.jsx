    ...
    return(
      <Router>
        <Message color='black' className='toast'>
          ...
          <p>
            Be the change against racial injustice: demand police accountability by <a href="https://www.brooklynnaacp.org/repeal50a" target="_blank">repealing 50-a</a>, and demand to <a href="https://docs.google.com/spreadsheets/d/18pWRSu58DpENABkYUJlZw1ltCPZft7KJc6lFaOZK8-s/htmlview?sle=true&pru=AAABcq-h3HA*oh7juZvqh_r6uiGrz12t1A#" target="_blank">defund the NYPD</a>.
          </p>
        </Message>
        <Mapbox />
      </Router>
