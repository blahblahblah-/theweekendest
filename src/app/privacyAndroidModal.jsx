    ...
    return(
      <Modal basic
        ...
        <Helmet>
          ...
          <meta property="og:url" content={`https://www.subwaynow.app/privacy-android`} />
          <meta name="twitter:url" content={`https://www.subwaynow.app/privacy-android`} />
          <link rel="canonical" href={`https://www.subwaynow.app/privacy-android`} />
        </Helmet>
        <Modal.Header>
          App Privacy Policy
        </Modal.Header>
